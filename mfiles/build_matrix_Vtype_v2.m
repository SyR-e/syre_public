...
function rotore = build_matrix_Vtype_v2(temp,geo)
...
XcRaccpontRadSx=temp.XcRaccpontRadSx;
...
for ii=1:nlay
    ...
    if (YpontRadSx(ii)~=0) % ponticello radiale
        rotore = [rotore
            XcRaccpontRadSx(ii) YcRaccpontRadSx(ii) XpontRadBarSx(ii) YpontRadBarSx(ii) XpontRadSx(ii)    YpontRadSx(ii)    1 codMatAirRot indexEle
            XpontRadSx(ii)      YpontRadSx(ii)      XpontRadDx(ii)    YpontRadDx(ii)    NaN               NaN               0 codMatAirRot indexEle
            XcRaccpontRadDx(ii) YcRaccpontRadDx(ii) XpontRadDx(ii)    YpontRadDx(ii)    XpontRadBarDx(ii) YpontRadBarDx(ii) 1 codMatAirRot indexEle
            ];
    else
        rotore = [rotore
