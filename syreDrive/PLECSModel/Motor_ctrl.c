        ...
        case START:			
			...
			//-----------------------Control Strategy--------------------------//
			 ...
			 switch(Ctrl_strategy){
                ...
                //----------------Feed Forward---------------------------//
                id_var.ffw = RS*isdq.d - omega_elt*lambda_dq.q;
                iq_var.ffw = RS*isdq.q + omega_elt*lambda_dq.d;
                 
			    //------------------Current Loops------------------------//
			    // Current_loop(vdc, Imax, isdq_ref, isdq,&id_par, &id_var, &iq_par, &iq_var, &vsdq_ref);   
				//d-axis control loop
				id_par.lim = vdc*SQRT1OVER3;
				...
				//q-axis control loop
				iq_par.lim   = sqrtf(vdc*SQRT1OVER3*vdc*SQRT1OVER3-vsdq_ref.d*vsdq_ref.d);
