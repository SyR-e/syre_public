...
Fd_v=linspace(Fd_min,Fd_max,n_points);
Fq_v=linspace(Fq_min,Fq_max,n_points);
th_v=linspace(min(th_dqt,[],'all'),max(th_dqt,[],'all'),n_points);
...
save('SimMatFiles\InvFluxMapdq','fd_v','fq_v','Id','Iq');
save('SimMatFiles\InvFluxMapdqt','Fd_max','Fq_max','Fd_min','Fq_min','th_min','th_max','th_dqt','Fd_v','Fq_v','th_v','Id_dqt','Iq_dqt','T_dqt');
save('SimMatFiles\UserSettings','Ctrl_type','SS_on','inj_waveform','dem','HS_ctrl','FMapsModel','InverterModel','Quad_Maps','id_MTPA','iq_MTPA','Ld_inic','Lq_inic');
