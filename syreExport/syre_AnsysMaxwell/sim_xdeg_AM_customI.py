...
#oDesign.DeleteDataset("Ia_time3")
#oDesign.DeleteDataset("Ib_time3")
#oDesign.DeleteDataset("Ic_time3")

oDesign.ImportDataset (r'%s/temp/Ia_time.tab'%(currentFolder))
oDesign.ImportDataset (r'%s/temp/Ib_time.tab'%(currentFolder))
oDesign.ImportDataset (r'%s/temp/Ic_time.tab'%(currentFolder))
...
oModule.AssignWindingGroup(
	[
		...
		"Type:="		, "Current",
		"IsSolid:="		, False,
		"Current:="		, "pwl(Ia_time%s,time)"%(simdata["dataset_counter"]), 
		"Resistance:="		, "0ohm",
		"Inductance:="		, "0nH",
		"Voltage:="		, "0mV",
...
oModule.AssignWindingGroup(
	[
		...
		"Type:="		, "Current",
		"IsSolid:="		, False,
		"Current:="		, "pwl(Ib_time%s,time)"%(simdata["dataset_counter"]),
		"Resistance:="		, "0ohm",
		"Inductance:="		, "0nH",
		"Voltage:="		, "0mV",
		"ParallelBranchesNum:="	, "1"
...
oModule.AssignWindingGroup(
	[
		...
		"Type:="		, "Current",
		"IsSolid:="		, False,
		"Current:="		, "pwl(Ic_time%s,time)"%(simdata["dataset_counter"]), 
		"Resistance:="		, "0ohm",
		"Inductance:="		, "0nH",
		"Voltage:="		, "0mV",
		"ParallelBranchesNum:="	, "1"
...
if simdata["n_PM"]!=0:
	...
	for jj in range (2):
		...
		for kk in range(int(simdata["n_PM"]/2)):
			...
			#[
             # "NAME:Current%d",%(rotorindex)
             # "Faces:= ", "2_%d",%(rotorindex)
             # "Current:=" , "0mA",
             # "IsSolid:=" , True,
